...
const Task: React.FC<TaskProps> = ({ title, subtitle, id }) => {
    ...
    return (<Pressable onPress={handleOnPress} >
        <View style={styles.container} >
            <View style={styles.viewTitle}>
                <Image style={{ marginTop: 3 }} source={require('../../assets/img/icontask.png')} />
                <View style={{ flexShrink: 1 }}>
                    <View>
                        <Text numberOfLines={2} style={{ fontWeight: '600', fontSize: 14, lineHeight: 20 }}>
                            {title}
                        </Text></View>
                    <View>
            ...
            <View style={styles.viewButton}>
                <Pressable style={styles.createButton} onPress={handleOnCreateTask}>
                    <Text style={{ flexShrink: 1, fontWeight: '600', fontSize: 14 }}>Tạo Phiếu</Text>
                    {iconArrow({ size: "20" })}
                </Pressable>
            </View>
        </View></Pressable>
